			...
			<div class="span10">
				...
				<div align="left">
					<form class="form-horizontal">
					    <s:textfield cssStyle="WIDTH:99%" label="收件人员"></s:textfield>
					    <s:textfield cssStyle="WIDTH:99%" label="抄送人员"></s:textfield>
					    <s:textfield cssStyle="WIDTH:99%" label="邮件主题"></s:textfield>
						<sjr:ckeditor 
						    id="richtextEditor" 
							name="echo" 
					        height="600"
